...
async function setup() {
  console.log('');
  console.log('============================================');
  console.log('  アメブロ自動投稿ツール - セットアップ');
  console.log('============================================');
  console.log('');
  ...
  console.log('\n--- 2/3: アメブロ ---');
  console.log('アメブロのログインID・パスワードを設定します。\n');
  const amebloId = await askWithDefault('アメブロID', 'AMEBLO_ID');
  const amebloPass = await askWithDefault('アメブロパスワード', 'AMEBLO_PASSWORD');
...
`;
  ...
  console.log('     npm run test:login     (アメブロログイン)');
  console.log('');
